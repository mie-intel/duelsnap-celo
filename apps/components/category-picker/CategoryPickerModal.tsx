          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span
                    ...
                    style={
                      mode === 'free'
                        ? { backgroundColor: 'rgba(53,208,127,0.15)', color: 'var(--color-primary)' }
                        : { backgroundColor: 'rgba(251,204,92,0.15)', color: 'var(--color-secondary)' }
                    }
                  >
              ...
              <div className="flex flex-col gap-2 pt-1">
                <Button onClick={handleConfirm} disabled={!selectedCategory} size="md" className="w-full">
                  Start Game
                </Button>
