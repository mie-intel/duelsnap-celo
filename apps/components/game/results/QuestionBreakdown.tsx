    ...
    <div className="flex flex-col gap-3">
      ...
      >
        {results.map((r, i) => (
          ...
          >
            {/* Question number */}
            <span className="text-[var(--color-text-secondary)] text-xs font-mono w-4 shrink-0 text-right">
              {i + 1}
            </span>
            ...
            {/* Guess */}
            <p className="flex-1 font-sans text-sm text-[var(--color-text-primary)] uppercase truncate min-w-0">
              {r.guess || '—'}
            </p>
            ...
            {r.correct ? (
              ...
              <XIcon className="w-5 h-5 text-error shrink-0" />
            )}
          </motion.div>
        ))}
      </motion.div>
